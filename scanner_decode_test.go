...
// TestScannerDecodeScenario tests the exact reflection patterns used in scanner.go and decoder.go
// This ensures that scanning and decoding operations work correctly with tinyreflect
func TestScannerDecodeScenario(t *testing.T) {
	...
	// Test the exact conditions from getElementType (scanner functionality)
	testGetElementType(t, originalTyp)
	testGetElementType(t, typ)
}

func testGetElementType(t *testing.T, typ *tinyreflect.Type) {
